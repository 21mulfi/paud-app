@if(Auth::check())
  <nav class="navbar navbar-expand-lg navbar-light bg-light border text-dark">
    ...
    @if(Auth::user()->role == 'orangtua')
        <a class="navbar-brand fw-bold ms-3" href="{{ route('orangtua.index') }}">
    @endif
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="welcome-message me-3">
                <span class="fw-bold text-dark">{{ ucfirst(Auth::user()->name) }}</span>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                @if(Auth::user()->role == 'admin')
                <a class="nav-link active text-light" aria-current="page" href="{{ route('admin.index') }}"><i class="fa fa-tachometer ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Dashboard</a>
                @endif
                @if(Auth::user()->role == 'guru')
                <a class="nav-link active text-light" aria-current="page" href="{{ route('guru.index') }}"><i class="fa fa-tachometer ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Dashboard</a>
                @endif
                @if(Auth::user()->role == 'orangtua')
                <a class="nav-link active text-light" aria-current="page" href="{{ route('orangtua.index') }}"><i class="fa fa-tachometer ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Dashboard</a>
                @endif
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="{{ route('admin.registration') }}"><i class="fa fa-check-square-o ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Verifikasi Registrasi</a>
            </li>
            @endif
  
            @if(Auth::user()->role == 'guru')
            <li class="nav-item">
              <a class="nav-link text-light" href="{{ route('guru.listsiswa') }}"><i class="fa fa-list ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Daftar Siswa</a>
            </li>
            <li class="nav-item">
            ...
            @if(Auth::user()->role == 'orangtua')
            <li class="nav-item">
              <a class="nav-link text-light" href="{{ route('orangtua.report') }}"><i class="fa fa-book ms-3" aria-hidden="true"></i>&nbsp;&nbsp;Laporan Siswa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="{{ route('orangtua.payment') }}"><i class="fa fa-money ms-3" aria-hidden="true"></i>&nbsp;&nbsp;History Pembayaran</a>
            </li>
            @endif
          </ul>
        </div>
